...
#define useList     _Rv014
float _down0H=6015     ;// 40 Ceies degree : 6.015 k
float _down0L=26300    ;//  0 Ceies degree : 26.3  k
float _targetH=0.481   ;
float _targetL=0.708   ;
//  E12
float _Rv011[]={10, 12, 15, 18, 22, 27, 33, 39, 47, 56, 68, 82};
//  E24
float _Rv012[]={10, 11, 12, 13, 15, 16, 18, 20, 22, 24, 27, 30, 33, 36, 39, 43, 47, 51, 56, 62, 68, 75, 82, 91};
//  E48
float _Rv013[]={10.0, 10.5, 11.0, 11.5, 12.1, 12.7, 13.3, 14.0, 14.7, 15.4, 16.2, 16.9, 17.8, 18.7, 19.6, 20.5, 21.5, 22.6, 23.7, 24.9, 26.1, 27.4, 28.7, 30.1, 31.6, 33.2, 34.8, 36.5, 38.3, 40.2, 42.2, 44.2, 46.4, 48.7, 51.1, 53.6, 56.2, 59.0, 61.9, 64.9, 68.1, 71.5, 75.0, 78.7, 82.5, 86.6, 90.9, 95.3 };
//  E96
float _Rv014[]={10.0, 10.2, 10.5, 10.7, 11.0, 11.3, 11.5, 11.8, 12.1, 12.4, 12.7, 13.0, 13.3, 13.7, 14.0, 14.3, 14.7, 15.0, 15.4, 15.8, 16.2, 16.5, 16.9, 17.4, 17.8, 18.2, 18.7, 19.1, 19.6, 20.0, 20.5, 21.0, 21.5, 22.1, 22.6, 23.2, 23.7, 24.3, 24.9, 25.5, 26.1, 26.7, 27.4, 28.0, 28.7, 29.4, 30.1, 30.9, 31.6, 32.4, 33.2, 34.0, 34.8, 35.7, 36.5, 37.4, 38.3, 39.2, 40.2, 41.2, 42.2, 43.2, 44.2, 45.3, 46.4, 47.5, 48.7, 49.9, 51.1, 52.3, 53.6, 54.9, 56.2, 57.6, 59.0, 60.4, 61.9, 63.4, 64.9, 66.5, 68.1, 69.8, 71.5, 73.2, 75.0, 76.8, 78.7, 80.6, 82.5, 84.5, 86.6, 88.7, 90.9, 93.1, 95.3, 97.6 };
float * _Rv02 ;
int16_t _len02 ;

float * _calc_all_input_range( float * ___input , int16_t ___len) ;
int main( int ___argc, char ** ___argv ) {
    _calc_all_input_range( useList , sizeof(useList)/sizeof(useList[0]) );
    return 0 ;
...
float * _calc_all_input_range( float * ___input , int16_t ___len) {
    ...
    printf( "len : %d \n" , ___len );
    __rv = malloc(3*sizeof(float) );
    _Rv02=__rv ;
    for ( int16_t __j = 0 ; __j ++ ; __j < ___len ) {
        __rv[__j]                   = ___input[__j] ;
        __rv[__j+___len]            = ___input[__j] * 10;
        __rv[__j+___len+___len]     = ___input[__j] * 100;
    }
} // _calc_all_input_range
/*
